...
namespace osum.GameModes
{
	class MainMenu : GameMode
	{
		...
		internal override void Initialize()
		{
			...
			osuLogo = new pSprite(TextureManager.Load(@"menu-osu"), FieldTypes.StandardSnapCentre, OriginTypes.Centre, ClockTypes.Game, Vector2.Zero, 0.9f, true, Color4.White);
			spriteManager.Add(osuLogo);
			
            pSprite explosion = new pSprite(TextureManager.Load(@"menu-explosion"), FieldTypes.StandardSnapCentre, OriginTypes.Centre, ClockTypes.Game, new Vector2(-110,-110), 0.8f, true, new Color4(252,6,127,255));
            ...
            explosion = new pSprite(TextureManager.Load(@"menu-explosion"), FieldTypes.StandardSnapCentre, OriginTypes.Centre, ClockTypes.Game, new Vector2(140, 10), 0.8f, true, new Color4(255, 212, 27, 255));
            explosion.Transform(new TransformationBounce(initial_display + 200, initial_display + 2900, 1.4f, 1.4f, 8));
            explosions.Add(explosion);
            spriteManager.Add(explosion);

            explosion = new pSprite(TextureManager.Load(@"menu-explosion"), FieldTypes.StandardSnapCentre, OriginTypes.Centre, ClockTypes.Game, new Vector2(-120, 60), 0.8f, true, new Color4(29, 209, 255, 255));
