...
namespace osum.Input.Sources
{
    ...
    unsafe class NativeWindowHook : NativeWindow
    {
    ...
    unsafe class InputSourceRaw : InputSource
    {
        ...
        [DllImport("user32.dll")]
        public static extern bool GetTouchInputInfo(IntPtr hTouchInput, int uiNumDevices, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1), Out] RawTouchInput[] pRawTouchInputs, int cbSize);
